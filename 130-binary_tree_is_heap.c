...
int btic_assistant(const binary_tree_t *tree, size_t index, size_t size);
...
int binary_tree_is_complete(const binary_tree_t *tree)
{
	...
	return (btic_assistant(tree, 0, size));
}
...
int btic_assistant(const binary_tree_t *tree, size_t index, size_t size)
{
	...
	return (btic_assistant(tree->left, 2 * index + 1, size) &&
		btic_assistant(tree->right, 2 * index + 2, size));
}
